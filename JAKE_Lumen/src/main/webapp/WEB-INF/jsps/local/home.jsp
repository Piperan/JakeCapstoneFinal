...
<title>Local Authority Approval</title>
...
<div class="container">
  <div class="row">
   ...
   <br><br>
    <a  href="<c:url value="/certify/${project.projectId}"/>" style="width:60%;margin:auto" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">Register Project </a>
    <br><br>
    </div>
  </div>
</div>
